...
import { Mail, Lock, User, Phone, ArrowRight, Loader, ArrowLeft, Eye, EyeOff, CheckCircle } from 'lucide-react';
    ...
    if (registrationSuccess) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-white to-[#F8F8F8] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl relative z-10 border border-[#DFC5FE]/30 text-center">
                    <div className="flex flex-col items-center">
                        <div className="w-20 h-20 bg-[#6DBE45]/20 rounded-full flex items-center justify-center mb-6">
                            <CheckCircle className="w-10 h-10 text-[#6DBE45]" />
                        </div>
                        <h2 className="text-3xl font-serif font-bold text-[#6DBE45] mb-4">
                        ...
                        <button
                            ...
                            className="w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-full text-white bg-[#6DBE45] hover:bg-[#5da838] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6DBE45] transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                        >
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl relative z-10 border border-[#DFC5FE]/30">
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-2 text-center text-sm text-gray-500">
                        Join Lavanta for exclusive offers
                    </p>
                </div>
                {error && (
